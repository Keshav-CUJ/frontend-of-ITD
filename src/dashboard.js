...
function AnomalyDashboard() {
  ...
  const handleUpload = async () => {
    ...
    try {
      setLoading(true);
      await axios.post("https://backend-of-itd-production.up.railway.app/upload", formData);
      alert("File uploaded successfully!");
      const response = await axios.get("https://backend-of-itd-production.up.railway.app/get_user_dates");
  ...
  const handlePredict = async () => {
    try {
      setLoading(true);
      const response = await axios.post("https://backend-of-itd-production.up.railway.app/predict");
